...
*   **Сверхъяркий фонарик:** Встроенный светодиод мощностью 100 мА.
...
*   **ИК-глушилка:** Режим, который "забивает" эфир ИК-помехами, временно блокируя работу ИК-приемников в помещении (телевизоры, кондиционеры и т.д.).
*   **Micro Power Bank:** Возможность отдать часть заряда для экстренной подзарядки других устройств через USB.
...
Схема и печатная плата были разработаны в среде **EasyEDA**. В качестве "мозга" устройства был выбран микроконтроллер STM8S003F3P6 благодаря его относительно низкому энергопотреблению и наличию необходимой периферии.

Платы заказывались на фабрике через сервис JLCPCB/PCBWay. Первая ревизия была двухслойной, вторая (с функцией power bank) — также.
...
### 3. Разработка корпуса и механика (Enclosure & Mechanics)

Корпус был спроектирован в **КОМПАС-3D** с учетом всех компонентов и эргономики. Для изготовления использовался домашний SLA 3D-принтер **Anycubic Photon Mono**, который обеспечивает высокую точность и качество поверхности. После печати детали "закалялись" в УФ-камере для придания им прочности.

Особая деталь — защитное стеклышко для 7-сегментного индикатора. Оно было вырезано из акрила на кастомном ЧПУ-станке с водяным охлаждением шпинделя, чтобы избежать оплавления материала.

![Домашнийй ЧПУ-станок](img/cnc.jpg)

### 4. Программное обеспечение (Firmware)
...
*   **Конечный автомат (State Machine):** Управляет режимами работы устройства (экран блокировки, главное меню, фонарик, ИК-пульт и т.д.).
*   **Обработка прерываний:** Захват ИК-сигнала реализован через внешние прерывания (EXTI) на ножке ИК-приемника. Таймеры TIM1 и TIM2 используются для точного измерения длительности импульсов и пауз.
